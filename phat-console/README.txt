...
#Command to get information commands
>help info
...
#To get information of the available characters.
>body info
...
#There are two: Human0 and Sujeto1. Sujeto 1 will be choosen.
#Before, we need to know the name of the command
>help body
...
# The object inside of the Kitchen
>envInfo Kitchen
envInfo (6):
-------------------------------------------------------
...
#When a command is finished, the method returns the result Fail or Success:

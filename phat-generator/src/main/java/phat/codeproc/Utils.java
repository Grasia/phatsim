...
public class Utils {
	 ...
	 * 
	 * @param string
	 *            The string being converted, like white spaces
	 ...
	 *            The name of the relationship which will be studied
	 * @param role
	 *            The name of the extreme of the relationship that has to be
	 *            studied
	 ...
	 * 
	 * @param pathname
	 *            Part of a path name. It will force located relationships to
	 *            belong to concrete sets of diagrams allocated in concrete
	 *            packages
	 * @param element
	 *            The element to be studied
	 * @param relationshipname
	 ...
	 * 
	 * @param type
	 *            The type the application is looking for
	 * @return
	 ...
	 * @throws NullEntity
	 */
	public static Collection<GraphEntity> getEntities(Graph g, String typeName)
			throws NullEntity {

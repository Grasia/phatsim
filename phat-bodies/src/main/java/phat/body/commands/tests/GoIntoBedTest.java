 ...
 * @author pablo
 */
public class GoIntoBedTest implements PHATInitAppListener {
    ...
    public static void main(String[] args) {
        GoIntoBedTest test = new GoIntoBedTest();
    ...
    public void init(SimpleApplication app) {
        ...
        //sitDown("WC1");
        //goToUse("Sink");
        bodiesAppState.runCommand(new GoIntoBedCommand("Patient", null));

...
public class BVHRagdollPreset extends RagdollPreset {
    ...
    protected void initBoneMap() {        
        ...
        boneMap.put("Spine1", new JointPreset(0f,0f,0f,0f,0f,0f));
        boneMap.put("Spine", new JointPreset(0f,0f,0f,0f,0f,0f));
        boneMap.put("LowerBack", new JointPreset(0f,0f,0f,0f,0f,0f));
        
        boneMap.put("RightUpLeg", new JointPreset(FastMath.QUARTER_PI/2f, 0f/*-FastMath.QUARTER_PI*1.6f*/, 0f, 0f, FastMath.QUARTER_PI, 0f/*-FastMath.QUARTER_PI/2f*/));
        boneMap.put("RightLeg", new JointPreset(FastMath.HALF_PI*1.2f, 0f, 0f,0f,0f,0f));
        
        boneMap.put("LeftUpLeg", new JointPreset(FastMath.QUARTER_PI/2f, 0f/*-FastMath.QUARTER_PI*1.6f*/, 0f, 0f, FastMath.QUARTER_PI, 0f/*-FastMath.QUARTER_PI/2f*/));

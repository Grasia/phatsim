 ...
 */
package phat.actuators.speakers;
 ...
 * @author pablo
 */
public class TextToSpeachSpeaker extends PHATCommand implements AudioSourceStatusListener {
    ...
    public TextToSpeachSpeaker(String bodyId, String message, PHATCommandListener listener) {
        super(listener);
        this.bodyId = bodyId;
    ...
    public TextToSpeachSpeaker(String bodyId, String message) {
